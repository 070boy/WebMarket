...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-5">
				<img src="/WebMarket/upload/<%=rs.getString("p_fileName")%>" style="width: 100%">
			</div>
		<div class="col-md-7">
			<form name="newProduct" action="./processUpdateProduct.jsp" class="form-horm-horizontal" method="post" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input type="radio" id="condition" value="New">신규 제품
						<input type="radio" id="condition" value="Old">중고 제품
						<input type="radio" id="condition" value="Refurbished">재생 제품
					</div>
				</div>
				<div class="form-group row">
